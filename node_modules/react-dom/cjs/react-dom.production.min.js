...
exports.unstable_scheduleHydration=function(a){if(a){var b=u.unstable_getCurrentPriorityLevel(),c=ic();a={blockedOn:null,target:a,priority:b,lanePriority:c};for(c=0;c<rc.length&&!(b<=rc[c].priority);c++);rc.splice(c,0,a);0===c&&zc(a)}};exports.version="17.0.0-alpha.0-experimental-4ead6b530";
